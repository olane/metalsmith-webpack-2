  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h2">
        <a href="#baseline-setup">Baseline setup</a>
      </div>

      <div class="heading h2">
        <a href="#collection-functions">Collection Functions</a>
      </div>

      <div class="heading h2">
        <a href="#array-functions">Array Functions</a>
      </div>

      <div class="heading h2">
        <a href="#function-ahem-functions">Function (ahem) Functions</a>
      </div>

      <div class="heading h2">
        <a href="#object-functions">Object Functions</a>
      </div>
...
(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
      ...
      <tr>
        <td class="docs">
          <div class="pilwrap" id="baseline-setup">
  <h2>
    <a href="#baseline-setup" name="baseline-setup" class="pilcrow"></a>
Baseline setup
  </h2>
</div>
...
<p>Establish the root object, <code>window</code> in the browser, or <code>exports</code> on the server.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> root = <span class="hljs-keyword">this</span>;
...
<p>Save the previous value of the <code>_</code> variable.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> previousUnderscore = root._;
...
<p>Establish the object that gets returned to break out of a loop iteration.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> breaker = {};
...
<p>Save bytes in the minified (but not gzipped) version:</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> ArrayProto = <span class="hljs-built_in">Array</span>.prototype, ObjProto = <span class="hljs-built_in">Object</span>.prototype, FuncProto = <span class="hljs-built_in">Function</span>.prototype;
...
<p>Create quick reference variables for speed access to core prototypes.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span>
...
<p>Create a safe reference to the Underscore object for use below.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> _ = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Current version.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.VERSION = <span class="hljs-string">'1.6.0'</span>;
      ...
      <tr>
        <td class="docs">
          <div class="pilwrap" id="collection-functions">
  <h2>
    <a href="#collection-functions" name="collection-functions" class="pilcrow"></a>
...
Delegates to <strong>ECMAScript 5</strong>'s native <code>forEach</code> if available.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> each = _.each = _.forEach = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, iterator, context</span>) </span>{
...
Delegates to <strong>ECMAScript 5</strong>'s native <code>map</code> if available.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.map = _.collect = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, iterator, context</span>) </span>{
  ...
  <span class="hljs-keyword">var</span> reduceError = <span class="hljs-string">'Reduce of empty array with no initial value'</span>;
...
or <code>foldl</code>. Delegates to <strong>ECMAScript 5</strong>'s native <code>reduce</code> if available.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.reduce = _.foldl = _.inject = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, iterator, memo, context</span>) </span>{
...
Delegates to <strong>ECMAScript 5</strong>'s native <code>reduceRight</code> if available.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.reduceRight = _.foldr = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, iterator, memo, context</span>) </span>{
    <span class="hljs-keyword">var</span> initial = <span class="hljs-built_in">arguments</span>.length &gt; <span class="hljs-number">2</span>;
    <span class="hljs-keyword">if</span> (obj == <span class="hljs-literal">null</span>) obj = [];
...
<p>Return the first value which passes a truth test. Aliased as <code>detect</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.find = _.detect = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, predicate, context</span>) </span>{
...
Aliased as <code>select</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.filter = _.select = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, predicate, context</span>) </span>{
    <span class="hljs-keyword">var</span> results = [];
    <span class="hljs-keyword">if</span> (obj == <span class="hljs-literal">null</span>) <span class="hljs-keyword">return</span> results;
...
<p>Return all the elements for which a truth test fails.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.reject = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, predicate, context</span>) </span>{
...
Aliased as <code>all</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.every = _.all = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, predicate, context</span>) </span>{
...
Aliased as <code>any</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> any = _.some = _.any = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, predicate, context</span>) </span>{
    predicate || (predicate = _.identity);
...
Aliased as <code>include</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.contains = _.include = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, target</span>) </span>{
...
<p>Invoke a method (with arguments) on every item in a collection.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.invoke = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, method</span>) </span>{
...
<p>Convenience version of a common use case of <code>map</code>: fetching a property.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.pluck = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, key</span>) </span>{
...
containing specific <code>key:value</code> pairs.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.where = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, attrs</span>) </span>{
...
containing specific <code>key:value</code> pairs.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.findWhere = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, attrs</span>) </span>{
...
See <a href="https://bugs.webkit.org/show_bug.cgi?id=80797">WebKit Bug 80797</a></p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.max = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, iterator, context</span>) </span>{
...
<p>Return the minimum element (or element-based computation).</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.min = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, iterator, context</span>) </span>{
    <span class="hljs-keyword">if</span> (!iterator &amp;&amp; _.isArray(obj) &amp;&amp; obj[<span class="hljs-number">0</span>] === +obj[<span class="hljs-number">0</span>] &amp;&amp; obj.length &lt; <span class="hljs-number">65535</span>) {
...
<a href="http://en.wikipedia.org/wiki/Fisher%E2%80%93Yates_shuffle">Fisher-Yates shuffle</a>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.shuffle = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
The internal <code>guard</code> argument allows it to work with <code>map</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.sample = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, n, guard</span>) </span>{
...
<p>An internal function to generate lookup iterators.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> lookupIterator = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">value</span>) </span>{
...
<p>Sort the object's values by a criterion produced by an iterator.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.sortBy = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, iterator, context</span>) </span>{
    ...
    <span class="hljs-keyword">return</span> _.pluck(_.map(obj, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">value, index, list</span>) </span>{
      <span class="hljs-keyword">return</span> {
        ...
        <span class="hljs-attr">criteria</span>: iterator.call(context, value, index, list)
      };
...
<p>An internal function used for aggregate &quot;group by&quot; operations.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> group = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">behavior</span>) </span>{
...
to group by, or a function that returns the criterion.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.groupBy = group(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">result, key, value</span>) </span>{
...
when you know that your index values will be unique.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.indexBy = group(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">result, key, value</span>) </span>{
    result[key] = value;
  });
...
criterion.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.countBy = group(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">result, key</span>) </span>{
...
an object should be inserted so as to maintain order. Uses binary search.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.sortedIndex = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array, obj, iterator, context</span>) </span>{
    iterator = lookupIterator(iterator);
...
<p>Safely create a real, live array from anything iterable.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.toArray = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Return the number of elements in an object.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.size = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
    ...
    <span class="hljs-keyword">return</span> (obj.length === +obj.length) ? obj.length : _.keys(obj).length;
      ...
      <tr>
        <td class="docs">
          <div class="pilwrap" id="array-functions">
  <h2>
    <a href="#array-functions" name="array-functions" class="pilcrow"></a>
Array Functions
  </h2>
</div>
...
allows it to work with <code>_.map</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.first = _.head = _.take = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array, n, guard</span>) </span>{
...
<code>_.map</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.initial = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array, n, guard</span>) </span>{
...
values in the array. The <strong>guard</strong> check allows it to work with <code>_.map</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.last = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array, n, guard</span>) </span>{
    <span class="hljs-keyword">if</span> (array == <span class="hljs-literal">null</span>) <span class="hljs-keyword">return</span> <span class="hljs-keyword">void</span> <span class="hljs-number">0</span>;
...
check allows it to work with <code>_.map</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.rest = _.tail = _.drop = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array, n, guard</span>) </span>{
...
<p>Trim out all falsy values from an array.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.compact = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array</span>) </span>{
...
<p>Internal implementation of a recursive <code>flatten</code> function.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> flatten = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">input, shallow, output</span>) </span>{
...
<p>Flatten out an array, either recursively (by default), or just one level.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.flatten = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array, shallow</span>) </span>{
...
<p>Return a version of the array that does not contain the specified value(s).</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.without = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array</span>) </span>{
...
predicate, and one whose elements all do not satisfy the predicate.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.partition = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array, predicate</span>) </span>{
...
Aliased as <code>unique</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.uniq = _.unique = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array, isSorted, iterator, context</span>) </span>{
...
the passed-in arrays.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.union = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
...
passed-in arrays.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.intersection = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array</span>) </span>{
...
Only the elements present in just the first array will remain.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.difference = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array</span>) </span>{
...
an index go together.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.zip = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
...
the corresponding values.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.object = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">list, values</span>) </span>{
...
for <strong>isSorted</strong> to use binary search.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.indexOf = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array, item, isSorted</span>) </span>{
...
<p>Delegates to <strong>ECMAScript 5</strong>'s native <code>lastIndexOf</code> if available.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.lastIndexOf = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">array, item, from</span>) </span>{
    <span class="hljs-keyword">if</span> (array == <span class="hljs-literal">null</span>) <span class="hljs-keyword">return</span> <span class="hljs-number">-1</span>;
    <span class="hljs-keyword">var</span> hasIndex = <span class="hljs-keyword">from</span> != <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">if</span> (nativeLastIndexOf &amp;&amp; array.lastIndexOf === nativeLastIndexOf) {
      <span class="hljs-keyword">return</span> hasIndex ? array.lastIndexOf(item, <span class="hljs-keyword">from</span>) : array.lastIndexOf(item);
    }
    <span class="hljs-keyword">var</span> i = (hasIndex ? <span class="hljs-keyword">from</span> : array.length);
...
<a href="http://docs.python.org/library/functions.html#range">the Python documentation</a>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.range = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">start, stop, step</span>) </span>{
    ...
    <span class="hljs-keyword">return</span> range;
      ...
      <tr>
        <td class="docs">
          <div class="pilwrap" id="function-ahem-functions">
  <h2>
    <a href="#function-ahem-functions" name="function-ahem-functions" class="pilcrow"></a>
...
<p>Reusable constructor function for prototype setting.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> ctor = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>)</span>{};
...
available.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.bind = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">func, context</span>) </span>{
...
as a placeholder, allowing any combination of arguments to be pre-filled.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.partial = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">func</span>) </span>{
...
defined on an object belong to it.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.bindAll = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Memoize an expensive function by storing its results.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.memoize = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">func, hasher</span>) </span>{
...
it with the arguments supplied.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.delay = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">func, wait</span>) </span>{
    <span class="hljs-keyword">var</span> args = slice.call(<span class="hljs-built_in">arguments</span>, <span class="hljs-number">2</span>);
...
cleared.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.defer = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">func</span>) </span>{
...
<code>{leading: false}</code>. To disable execution on the trailing edge, ditto.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.throttle = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">func, wait, options</span>) </span>{
...
leading edge, instead of the trailing.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.debounce = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">func, wait, immediate</span>) </span>{
...
often you call it. Useful for lazy initialization.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.once = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">func</span>) </span>{
...
conditionally execute the original function.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.wrap = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">func, wrapper</span>) </span>{
...
consuming the return value of the function that follows.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.compose = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
...
<p>Returns a function that will only be executed after being called N times.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.after = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">times, func</span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
      ...
      <tr>
        <td class="docs">
          <div class="pilwrap" id="object-functions">
  <h2>
    <a href="#object-functions" name="object-functions" class="pilcrow"></a>
Object Functions
  </h2>
</div>
...
Delegates to <strong>ECMAScript 5</strong>'s native <code>Object.keys</code></p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.keys = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Retrieve the values of an object's properties.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.values = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
    <span class="hljs-keyword">var</span> keys = _.keys(obj);
...
<p>Convert an object into a list of <code>[key, value]</code> pairs.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.pairs = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
    <span class="hljs-keyword">var</span> keys = _.keys(obj);
    <span class="hljs-keyword">var</span> length = keys.length;
...
<p>Invert the keys and values of an object. The values must be serializable.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.invert = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
    <span class="hljs-keyword">var</span> result = {};
    <span class="hljs-keyword">var</span> keys = _.keys(obj);
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>, length = keys.length; i &lt; length; i++) {
...
Aliased as <code>methods</code></p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.functions = _.methods = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Extend a given object with all the properties in passed-in object(s).</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.extend = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Return a copy of the object only containing the whitelisted properties.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.pick = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Return a copy of the object without the blacklisted properties.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.omit = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
    <span class="hljs-keyword">var</span> copy = {};
    <span class="hljs-keyword">var</span> keys = concat.apply(ArrayProto, slice.call(<span class="hljs-built_in">arguments</span>, <span class="hljs-number">1</span>));
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> key <span class="hljs-keyword">in</span> obj) {
...
<p>Fill in a given object with default properties.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.defaults = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
    each(slice.call(<span class="hljs-built_in">arguments</span>, <span class="hljs-number">1</span>), <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">source</span>) </span>{
      <span class="hljs-keyword">if</span> (source) {
        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> prop <span class="hljs-keyword">in</span> source) {
...
<p>Create a (shallow-cloned) duplicate of an object.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.clone = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
order to perform operations on intermediate results within the chain.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.tap = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, interceptor</span>) </span>{
    interceptor(obj);
    <span class="hljs-keyword">return</span> obj;
  };
...
<p>Internal recursive comparison function for <code>isEqual</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> eq = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">a, b, aStack, bStack</span>) </span>{
</pre>
        </td>
      </tr>
...
See the <a href="http://wiki.ecmascript.org/doku.php?id=harmony:egal">Harmony <code>egal</code> proposal</a>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (a === b) <span class="hljs-keyword">return</span> a !== <span class="hljs-number">0</span> || <span class="hljs-number">1</span> / a == <span class="hljs-number">1</span> / b;
</pre>
        </td>
      </tr>
...
<p>A strict comparison is necessary because <code>null == undefined</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (a == <span class="hljs-literal">null</span> || b == <span class="hljs-literal">null</span>) <span class="hljs-keyword">return</span> a === b;
</pre>
        </td>
      </tr>
...
<p>Unwrap any wrapped objects.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (a <span class="hljs-keyword">instanceof</span> _) a = a._wrapped;
    <span class="hljs-keyword">if</span> (b <span class="hljs-keyword">instanceof</span> _) b = b._wrapped;
</pre>
        </td>
      </tr>
...
<p>Compare <code>[[Class]]</code> names.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">var</span> className = toString.call(a);
...
<p>Strings, numbers, dates, and booleans are compared by value.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">      <span class="hljs-keyword">case</span> <span class="hljs-string">'[object String]'</span>:
</pre>
        </td>
      </tr>
...
equivalent to <code>new String(&quot;5&quot;)</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">        <span class="hljs-keyword">return</span> a == <span class="hljs-built_in">String</span>(b);
...
other numeric values.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">        <span class="hljs-keyword">return</span> a != +a ? b != +b : (a == <span class="hljs-number">0</span> ? <span class="hljs-number">1</span> / a == <span class="hljs-number">1</span> / b : a == +b);
...
of <code>NaN</code> are not equivalent.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">        <span class="hljs-keyword">return</span> +a == +b;
</pre>
        </td>
      </tr>
...
<p>RegExps are compared by their source patterns and flags.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">      <span class="hljs-keyword">case</span> <span class="hljs-string">'[object RegExp]'</span>:
...
structures is adapted from ES 5.1 section 15.12.3, abstract operation <code>JO</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">var</span> length = aStack.length;
...
unique nested structures.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">      <span class="hljs-keyword">if</span> (aStack[length] == a) <span class="hljs-keyword">return</span> bStack[length] == b;
    }
</pre>
        </td>
      </tr>
...
from different frames are.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">var</span> aCtor = a.constructor, bCtor = b.constructor;
...
<p>Add the first object to the stack of traversed objects.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    aStack.push(a);
    bStack.push(b);
    <span class="hljs-keyword">var</span> size = <span class="hljs-number">0</span>, result = <span class="hljs-literal">true</span>;
</pre>
        </td>
      </tr>
...
<p>Recursively compare objects and arrays.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (className == <span class="hljs-string">'[object Array]'</span>) {
</pre>
        </td>
      </tr>
...
<p>Compare array lengths to determine if a deep comparison is necessary.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">      size = a.length;
...
<p>Deep compare the contents, ignoring non-numeric properties.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">        <span class="hljs-keyword">while</span> (size--) {
...
<p>Deep compare objects.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">      <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> key <span class="hljs-keyword">in</span> a) {
        <span class="hljs-keyword">if</span> (_.has(a, key)) {
</pre>
        </td>
      </tr>
...
<p>Deep compare each member.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">          <span class="hljs-keyword">if</span> (!(result = _.has(b, key) &amp;&amp; eq(a[key], b[key], aStack, bStack))) <span class="hljs-keyword">break</span>;
        }
      }
</pre>
        </td>
...
<p>Remove the first object from the stack of traversed objects.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    aStack.pop();
    bStack.pop();
    <span class="hljs-keyword">return</span> result;
  };
...
<p>Perform a deep comparison to check if two objects are equal.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.isEqual = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">a, b</span>) </span>{
...
An &quot;empty&quot; object has no enumerable own-properties.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.isEmpty = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Is a given value a DOM element?</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.isElement = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
Delegates to ECMA5's native Array.isArray</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.isArray = nativeIsArray || <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Is a given variable an object?</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.isObject = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
there isn't any inspectable &quot;Arguments&quot; type.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (!_.isArguments(<span class="hljs-built_in">arguments</span>)) {
...
<p>Optimize <code>isFunction</code> if appropriate.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> (<span class="hljs-regexp">/./</span>) !== <span class="hljs-string">'function'</span>) {
...
<p>Is a given object a finite number?</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.isFinite = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Is the given value <code>NaN</code>? (NaN is the only number which does not equal itself).</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.isNaN = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Is a given value a boolean?</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.isBoolean = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Is a given value equal to null?</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.isNull = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Is a given variable undefined?</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.isUndefined = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
on itself (in other words, not on a prototype).</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.has = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, key</span>) </span>{
    <span class="hljs-keyword">return</span> hasOwnProperty.call(obj, key);
      ...
      <tr>
        <td class="docs">
          <div class="pilwrap" id="utility-functions">
  <h2>
    <a href="#utility-functions" name="utility-functions" class="pilcrow"></a>
Utility Functions
  </h2>
</div>
...
previous owner. Returns a reference to the Underscore object.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.noConflict = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
...
<p>Keep the identity function around for default iterators.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.identity = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">value</span>) </span>{
...
<p>Returns a predicate for checking whether an object has a given set of <code>key:value</code> pairs.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.matches = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">attrs</span>) </span>{
    <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Run a function <strong>n</strong> times.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.times = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">n, iterator, context</span>) </span>{
...
<p>Return a random integer between min and max (inclusive).</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.random = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">min, max</span>) </span>{
...
<p>A (possibly faster) way to get the current timestamp as an integer.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.now = <span class="hljs-built_in">Date</span>.now || <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{ <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Date</span>().getTime(); };
...
<p>List of HTML entities for escaping.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> entityMap = {
    <span class="hljs-attr">escape</span>: {
...
<p>Regexes containing the keys and values listed immediately above.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> entityRegexes = {
    <span class="hljs-attr">escape</span>:   <span class="hljs-keyword">new</span> <span class="hljs-built_in">RegExp</span>(<span class="hljs-string">'['</span> + _.keys(entityMap.escape).join(<span class="hljs-string">''</span>) + <span class="hljs-string">']'</span>, <span class="hljs-string">'g'</span>),
    <span class="hljs-attr">unescape</span>: <span class="hljs-keyword">new</span> <span class="hljs-built_in">RegExp</span>(<span class="hljs-string">'('</span> + _.keys(entityMap.unescape).join(<span class="hljs-string">'|'</span>) + <span class="hljs-string">')'</span>, <span class="hljs-string">'g'</span>)
  };
...
<p>Functions for escaping and unescaping strings to/from HTML interpolation.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.each([<span class="hljs-string">'escape'</span>, <span class="hljs-string">'unescape'</span>], <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">method</span>) </span>{
...
<code>object</code> as context; otherwise, return it.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.result = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">object, property</span>) </span>{
...
<p>Add your own custom functions to the Underscore object.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.mixin = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
Useful for temporary DOM ids.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> idCounter = <span class="hljs-number">0</span>;
...
following template settings to use alternative delimiters.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.templateSettings = {
...
guaranteed not to match.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> noMatch = <span class="hljs-regexp">/(.)^/</span>;
...
string literal.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> escapes = {
    <span class="hljs-string">"'"</span>:      <span class="hljs-string">"'"</span>,
    <span class="hljs-string">'\\'</span>:     <span class="hljs-string">'\\'</span>,
...
and correctly escapes quotes within interpolated code.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.template = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">text, data, settings</span>) </span>{
...
<p>Combine delimiters into one regular expression via alternation.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">var</span> matcher = <span class="hljs-keyword">new</span> <span class="hljs-built_in">RegExp</span>([
      (settings.escape || noMatch).source,
      (settings.interpolate || noMatch).source,
      (settings.evaluate || noMatch).source
    ].join(<span class="hljs-string">'|'</span>) + <span class="hljs-string">'|$'</span>, <span class="hljs-string">'g'</span>);
...
<p>If a variable is not specified, place data values in local scope.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (!settings.variable) source = <span class="hljs-string">'with(obj||{}){\n'</span> + source + <span class="hljs-string">'}\n'</span>;
...
<p>Provide the compiled function source as a convenience for precompilation.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    template.source = <span class="hljs-string">'function('</span> + (settings.variable || <span class="hljs-string">'obj'</span>) + <span class="hljs-string">'){\n'</span> + source + <span class="hljs-string">'}'</span>;
...
<p>Add a &quot;chain&quot; function, which will delegate to the wrapper.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.chain = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
    <span class="hljs-keyword">return</span> _(obj).chain();
      ...
      <tr>
        <td class="docs">
          <div class="pilwrap" id="oop">
  <h2>
    <a href="#oop" name="oop" class="pilcrow"></a>
OOP
  </h2>
</div>
...
<p>Helper function to continue chaining intermediate results.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> result = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj</span>) </span>{
...
<p>Add all of the Underscore functions to the wrapper object.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  _.mixin(_);
...
<p>Add all mutator Array functions to the wrapper.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  each([<span class="hljs-string">'pop'</span>, <span class="hljs-string">'push'</span>, <span class="hljs-string">'reverse'</span>, <span class="hljs-string">'shift'</span>, <span class="hljs-string">'sort'</span>, <span class="hljs-string">'splice'</span>, <span class="hljs-string">'unshift'</span>], <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">name</span>) </span>{
...
<p>Add all accessor Array functions to the wrapper.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  each([<span class="hljs-string">'concat'</span>, <span class="hljs-string">'join'</span>, <span class="hljs-string">'slice'</span>], <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">name</span>) </span>{
    <span class="hljs-keyword">var</span> method = ArrayProto[name];
    _.prototype[name] = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
...
<p>Start chaining a wrapped Underscore object.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    chain: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
...
<p>Extracts the result from a wrapped and chained object.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    value: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
